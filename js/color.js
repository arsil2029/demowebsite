...
*/!function (a) { "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof exports ? a(require("jquery")) : a(jQuery) }
        ...
        var b = /\+/g, h = a.cookie = function (b, f, i) {
            if (arguments.length > 1 && !a.isFunction(f)) {
                if (i = a.extend({}, h.defaults, i), "number" == typeof i.expires) {
                    var j = i.expires, k = i.expires = new Date; k.setTime(+k + 864e5 * j)
                }
    ...
    style_switcher = $('.color-customizer'), panelWidth = style_switcher.outerWidth(true);
    $('.color-customizer .opener').on("click", function () {
        var $this = $(this); if ($(".color-customizer.closed").length > 0) {
    ...
    var link = $('link[data-style="styles"]'), link_no_cookie = $('link[data-style="styles-no-cookie"]');
    $('.color-customizer .colorChange li').on('click', function () {
        if (link.length > 0) {
            ...
            link.attr('href', 'file:///E:/Umbraco/Final%20NBL%20HTML/css/' + tp_stylesheet + '.css');
    ...
    $('.color-customizer .reset a.reset-btn').on('click', function () {
        ...
        link.attr('href', 'css/theme-color/' + tp_stylesheet + '.css'); if ($("#logo-img").length > 0)
        {
            document.getElementById("logo-img").src = "images/logo-customizer/logo-" + tp_stylesheet + ".png";
        };
        $(window).trigger('resize'); $('.desktopTopFixed').removeClass('desktopTopFixed');
    });
});